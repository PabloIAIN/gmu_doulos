  ...
  try {
    switch (req.method) {
      ...
      case 'PUT': {
        ...
        await sql`UPDATE unidades SET nombre=COALESCE(${nombre||null},nombre),descripcion=COALESCE(${descripcion||null},descripcion),activo=COALESCE(${activo!==undefined?activo:null},activo) WHERE id=${id}`;
